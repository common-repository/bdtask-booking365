...
<div class = "multi-appointment row" > 
   <div class="scheduler_admin">
         <ul class="nav nav-tabs nav-pills" >
            ...
            <h5><?php esc_html_e('Service','booking365') ;?></h5></a></li>
            <li><a href="#add_service" data-toggle="tab">
            <h5><?php esc_html_e('Add Service','booking365') ;?></h5></a></li>              
        </ul>
                ...
                <table class="table table-bordered textColorForAllPage" 
                  ...
                  <tbody> 
                       ...
                       <tr>           
                          ...
                          <td><?php echo esc_html(ucwords($service->ser_name)) ; ?></td>
                          <td>                                                                      
                        ...
                        <div id="edit<?php echo $service->ser_id ; ?>" 
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                   <div class="modal-header">
                                     <button class="close" type="button" data-dismiss="modal">×</button>
                                      <h4 class="modal-title"><?php esc_html_e('Edit Service','booking365');?>
                                      </h4>
                                    </div>
                                    <div class="modal-body">
...
<div class = "row" >
    ...
    <label for = "ser_name"><?php esc_html_e('Service Name','booking365'); ?></label>
    <input name = "ser_name"; 
          type = "text" 
            id = "ser_name"                     
         class = "form-control">    
    ...
    <!-- //////////// Category Name  ///////////////////////////// -->
   <div class = "col-sm-12 form-group" >
   <label for = "ser_name"><?php esc_html_e('Select Category','booking365'); ?></label>  
    <?php 
    ...
    <label><input type  = "checkbox" 
                  ...
                  <?php echo esc_html($cat->cat_name) ; ?></label>
    </div>  
    <?php endforeach ;  ?>
    </div>
    </div>                          
    ...
    <input  type = "submit" 
            ...
            value= "<?php echo esc_attr('Add Service','booking365'); ?>">      
...
<div class="container-fluid">
  ...
  <!-- //////////// Service id  ///////////////////////////// -->
   ...
   <!-- //////////// Service Name  ///////////////////////////// -->
   <div class = "col-sm-12 form-group">                  
   <label for = "ser_name"><?php esc_html_e('Service Name','booking365'); ?></label></br>
   ...
   <input name = "ser_name"; type = "text" id = "ser_name"                     
    ...
    <!-- //////////// Category Name  ///////////////////////////// -->
    <div class = "col-sm-12 form-group">
    <label for = "ser_name"><?php esc_html_e('Category Name','booking365'); ?></label> 
    <?php 
    if(method_exists('Msbdt_Categorys','msbdt_process_category_select_data')) :
    global $wpdb ;
    $category = Msbdt_Categorys::msbdt_process_category_select_data();    
    ...
    <!-- //////////// End Category Name  ///////////////////////////// --> 
     ...
     <?php  esc_html_e('Close','booking365'); ?></button>        
     <input  type = "submit" 
