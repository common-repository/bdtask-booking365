...
<div class = "multi-appointment row" > 
   <div class="scheduler_admin">
         <ul class="nav nav-tabs nav-pills" >
            ...
            <h5><?php esc_html_e('Schedule','booking365') ;?></h5></a></li>
            <li><a href="#add_schedule" data-toggle="tab">
            <h5><?php esc_html_e('Add Schedule','booking365') ;?></h5></a></li>              
        </ul>
...
<?php elseif($message['action_status'] == 'something_is_error'): ?>
  <div id="message" class="updated notice is-dismissible">
      <p class="red"><strong><?php esc_html_e('This​ ​date​ ​&​ ​time​ ​​is​ ​already​ ​scheduled','multi_scheduler') ;?></strong></p>
              <button type="button" class="notice-dismiss">
              <span class="screen-reader-text"><?php esc_html_e('Dismiss this notice.','booking365') ;?></span>
              </button>
            </div> 
                ...
                <table class="table table-bordered textColorForAllPage" 
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><?php esc_html_e('Start Time','booking365') ;?></th>
                      <th><?php esc_html_e('End Time','booking365') ;?></th>
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button class="close" type="button" data-dismiss="modal">×</button>
                                      <h4 class="modal-title"><?php  esc_html_e('Delete Schedule','booking365');?>
                                      </h4>
                                   </div>
                        ...
                        <div id="edit<?php echo $schedule->slot_id ; ?>" 
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                   <div class="modal-header">
                                     <button class="close" type="button" data-dismiss="modal">×</button>
                                      <h4 class="modal-title"><?php esc_html_e('Edit Schedule','booking365');?>
                                      </h4>
                                    </div>
                                    <div class="modal-body">
...
<form  method = "post" 
 ...
 <?php if(!isset($slote->slot_id)):  ?>
    ...
    <div class = "col-sm-4"> 
    <div><label for=""><?php  echo esc_html( 'Available Date', 'booking365' ); ?></label></div>
    <div id    = "withAltField"  
         class = "form-group" >
  ...
  <div  class="<?php echo esc_attr(  $col_span ) ; ?>">
    ...
    <?php if( $slote !== null ): ?>  
      <div class = "form-group" >
        <label for   = "work_date"><?php esc_html_e('Work Date','booking365'); ?></label>
    ...
    <?php if(!isset($slote->int_val)):  ?>
      <div class = "form-group">
        <label for   =  "int_val"><?php echo esc_html('Time per schedule','booking365'); ?></label>
        <input name  =  "int_val" 
               type  =  "" 
               id    =  ""
               value =  "" 
...
<div  class="<?php echo esc_attr( $col_span ); ?>"> 
     ...
     <div class = "form-group" >
          <label for  = "start_time" ><?php  esc_html_e('Start Time','booking365'); ?></label>
      ...
      <div class = "form-group">
          <label for  =  "end_time"><?php esc_html_e('End Time','booking365'); ?></label>
          <span style =  "color:red;"><?php if(isset($errors['zip'])){echo $errors['zip'];}?></span>
          <input name =  "end_time" 
                 type =  "text"                                               
       ...
       <div class="modal-footer">
          <button class       = "btn btn-default" 
           ...
           <input type        = "submit" 
                 ...
                 value        = "<?php  esc_attr_e('Save Change','booking365'); ?>">                                            
      </div> 
    </div>    
    <?php else : ?>
        ...
        <label><input  type  = "submit" 
                       ...
                       class = "btn btn-primary" 
                       value = "<?php  esc_attr_e('Add New Schedule','booking365'); ?>"> 
                       </label>   
        </div>  
      <?php endif ; ?>                                 
  </form>
    ...
    <form  method = "post" 
        ...
        <input name = "slot_delete_id"; 
         ...
         <div class="modal-footer">
          <button class        = "btn btn-default" 
                  type         = "button" 
                  data-dismiss = "modal"><?php  esc_attr_e('Close','booking365'); ?></button>        
           <input type  = "submit" 
                  name  = "slote_delete" 
                  id    = "" 
                  class = "btn btn-warning" 
                  value = "<?php esc_attr_e('Delete','booking365'); ?>">                                            
        </div> 
