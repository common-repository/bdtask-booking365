...
<div class = "multi-appointment row" > 
   <div class="scheduler_admin">
         <ul class="nav nav-tabs nav-pills" >
            ...
            <h5><?php esc_html_e('Professional','booking365') ;?></h5></a></li>
            <li><a href="#add_professional" data-toggle="tab">
            <h5><?php esc_html_e('Add Professional','booking365') ;?></h5></a></li>              
        </ul>
      ...
      <div class = "row">
         <div class = "col-sm-7">
          <?php if($category['action_status'] == 'no_error_data_update_successfully'): ?>
                <div id="message" class="updated notice is-dismissible">
                  <p><strong><?php esc_html_e(' Update successful','multi_scheduler') ;?></strong></p>
                  <button type="button" class="notice-dismiss">
                  <span class="screen-reader-text"><?php esc_html_e('Dismiss this notice.','booking365') ;?></span>
                  </button>
                </div>         
  ...
  <div class = "row">
    <div class = "col-sm-7">
      <?php if($category['action_status'] == 'delete_successfully'): ?>
            <div id="message" class="updated notice is-dismissible">
              <p><strong><?php esc_html_e('Delete successful','multi_scheduler') ;?></strong></p>
              <button type="button" class="notice-dismiss">
                 ...
                 <thead>
                  ...
                  <tbody> 
                       ...
                       <tr>           
                          ...
                          <td><?php echo esc_html($professional->contact_no) ; ?></td>
                          <td>                                                                      
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button class="close" type="button" data-dismiss="modal">×</button>
                                      <h4 class="modal-title"><?php  esc_html_e('Delete Service','booking365');?>
                                      </h4>
                                   </div>
                        ...
                        <div id="edit<?php echo $professional->pro_id; ?>" 
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                   <div class="modal-header">
                                     <button class="close" type="button" data-dismiss="modal">×</button>
                                      <h4 class="modal-title"><?php esc_html_e('Edit Professional','booking365');?>
                                      </h4>
                                    </div>
                                    <div class="modal-body">
...
function professional_form_html( $pro = null , $col_label = null , $col_span = null , $errors = null){ ?>
   ...
   <form  method = "post" action = "" class = "row">
    ...
    <label for = "first_name"><?php esc_html_e('First Name','booking365'); ?></label>
    <input name="fname"; type="text"  id="first_name" class="form-control">     
    </div>
    <div class = "col-sm-12 form-group">                  
    <label for = "last_name"><?php esc_html_e('Last Name','booking365'); ?></label>
    <input name="lname"; type="text"  id="last_name" class="form-control">     
    </div>
    
    <div class = "col-sm-12 form-group">
    <label for = "service"><?php esc_html_e('Service','booking365'); ?></label>
    <?php 
    ...
    <div class="service_span"><input type  = "checkbox"
                  ...
                  <?php echo esc_html($service->ser_name) ; ?></div>
    <?php endforeach ;?>
    </div>
    </div>

    <div class = "col-sm-12 form-group">
    <label for="state"><?php echo esc_html('Sex','booking365'); ?></label>
    <input type = "radio" name = "sex"  value="male" checked>
    <?php esc_html_e('Male','booking365'); ?></span>
    <input type="radio" name="sex" value="female">
    <?php esc_html_e('Female','booking365'); ?>
    </div>

    <div class = "col-sm-12 form-group">
    <label  for="email"><?php echo esc_html('Email','booking365'); ?></label>   
    <input  name  = "email" 
            type  = "email" 
            id    = "email"                         
    ...
    <?php echo esc_html('Contact No','booking365'); ?>  </label>         
    <input name = "contact_no" 
     ...
     <div class = "col-sm-12 form-group">
     <label for="website">
     <?php esc_html_e('Website','booking365'); ?>  </label>
     <input name   = "website" 
            type  = "url" 
            id    = "website"                         
      ...
      <?php echo esc_html('Biographical Information','booking365'); ?></label>   
      <textarea                      
                 rows = "3"
                 ...
                 echo esc_html($pro->biographical_info); 
                 endif;  ?>                            
      </textarea>        
      </div>
       </div> 
        ...
        <input  type = "submit" name = "add_professional_submit" id   = "" class= "btn btn-primary" 
                value= "<?php echo esc_attr('Add New Professional','booking365'); ?>">      
        </div>
    </form>               
<?php }
...
function professional_form_edit_html( $pro = null , $col_label = null , $col_span = null , $errors = null){ ?>
   ...
   <form  method = "post" action = "" class = "row">
    ...
    <?php esc_html_e('Female','booking365'); ?></span>
    </div>
    <div class = "col-sm-12 form-group">
    <label  for="email"><?php echo esc_html('Email','booking365'); ?></label>   
    <input  name  = "email" 
