...
class Msbdt_Categorys{
   ...
   */  
   public static function  msbdt_process_category_data($category = null ){
      self::$category = Msbdt_Categorys::msbdt_category_name_sanitize() ;
      self::$category = Msbdt_Categorys::msbdt_category_table(  self::$category );
      self::$category = Msbdt_Categorys::msbdt_add_category(  self::$category );  
   ...
   */  
   ...
   public static function  msbdt_process_category_update_data($category = null ){
      self::$category = Msbdt_Categorys::msbdt_category_id_sanitize() ;
      self::$category = Msbdt_Categorys::msbdt_category_name_sanitize( self::$category ) ;
      self::$category = Msbdt_Categorys::msbdt_category_table(  self::$category );
      self::$category = Msbdt_Categorys::msbdt_update_category(  self::$category );  
      return self::$category;
   }
   ...
   */  
   ...
   public static function  msbdt_process_category_delete_data($category = null ){
      self::$category = Msbdt_Categorys::msbdt_category_id_sanitize() ;
      self::$category = Msbdt_Categorys::msbdt_category_table(  self::$category );
      self::$category = Msbdt_Categorys::msbdt_delete_category(  self::$category );  
      return self::$category;
   }
   ...
   */  
   ...
   public static function  msbdt_process_category_select_data($category = null ){
      self::$category = Msbdt_Categorys::msbdt_category_table(self::$category );
      self::$category = Msbdt_Categorys::msbdt_select_category(self::$category );  
      return self::$category;
   }
